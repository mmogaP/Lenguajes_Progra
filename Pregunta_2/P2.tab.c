...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_LETRA = 8,                      /* LETRA  */
  YYSYMBOL_DIAGONAL = 9,                   /* DIAGONAL  */
  YYSYMBOL_FIN = 10                        /* FIN  */
};
...
static const char *const yytname[] =
{
  ...
  "EJEX", "$accept", "INICIO", "LETRA", "DIAGONAL", "FIN", YY_NULLPTR
};
