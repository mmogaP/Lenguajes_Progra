...
static const char *const yytname[] =
{
  ...
  "$accept", "INICIO", "LETRA", "NUMERO", "DIAGONAL", "FIN", YY_NULLPTR
};
#endif
...
#line 1364 "P3.tab.c"
  ...
  case 8:
#line 76 "P3.y"
             {CalcularCoordenada((yyvsp[0].strVal),1);}
#line 1370 "P3.tab.c"
    break;
